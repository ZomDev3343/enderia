...
public class TPTntRenderer extends EntityRenderer<PrimedTPTnt> {
    ...
    @Override
    public ResourceLocation getTextureLocation(PrimedTPTnt pEntity) {
        return TextureAtlas.LOCATION_BLOCKS;
    }

    @Override
    public void render(PrimedTPTnt pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
        ...
        pMatrixStack.mulPose(Vector3f.YP.rotationDegrees(90.0F));
        TntMinecartRenderer.renderWhiteSolidBlock(ModObjects.TELEPORTING_TNT.get().defaultBlockState(), pMatrixStack, pBuffer, pPackedLight, i / 5 % 2 == 0);
